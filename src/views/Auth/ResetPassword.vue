          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            ...
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Masukkan kata sandi baru Anda di bawah ini untuk mereset kata sandi akun.
              </p>
            </div>
            ...
            <form @submit.prevent="handleSubmit">
              <div class="space-y-5">
                ...
                <div v-if="email" class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                  Mereset kata sandi untuk: <strong>{{ email }}</strong>
                </div>
                ...
                <div>
                  ...
                  <p v-if="confirmPassword && confirmPassword !== password" class="mt-1 text-xs text-error-500">
                ...
                <div>
                  ...
                  >
                    ...
                    <span v-if="loading">Mereset Kata Sandi...</span>
...
const handleSubmit = async () => {
  if (!password.value || !confirmPassword.value) {
    alert.error('Silakan isi semua field yang diperlukan')
    return
  }
  ...
  if (password.value.length < 6) {
    alert.error('Kata sandi harus minimal 6 karakter')
    return
  }
  ...
  try {
    ...
    if (response.status === 'success') {
      // Complete password reset and clear localStorage
      forgotPassword.completePasswordReset()
      
      await alert.success(
        'Reset Kata Sandi Berhasil!',
        'Kata sandi Anda telah berhasil diubah. Sekarang Anda dapat masuk dengan kata sandi baru.'
      )
      router.push('/signin')
    }
  } catch (error: unknown) {
    const errorMessage = (error as { response?: { data?: { message?: string } } }).response?.data?.message || 'Gagal mereset kata sandi'
...
onMounted(() => {
  ...
  if (!forgotPassword.canAccessStep('reset')) {
    alert.error('Akses tidak valid. Silakan verifikasi OTP terlebih dahulu.')
