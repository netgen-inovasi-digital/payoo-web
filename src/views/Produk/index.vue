            ...
            <form @submit.prevent="saveProduct" class="space-y-4">
              ...
              <div>
                ...
                <div class="flex items-center gap-4">
                  <img :src="productForm.photo || '/images/product/default.jpg'" alt="Product preview" v-if="productForm.photo"
                    class="w-24 h-24 object-cover rounded" />
                  <div class="flex-1">
                    <input type="file" accept="image/*" @change="handleImageUpload" class="w-full" :required="!productForm.photo" />
